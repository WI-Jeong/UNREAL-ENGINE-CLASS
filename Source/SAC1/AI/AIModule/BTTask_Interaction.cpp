	...
	UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	//애니메이션 run이 아니라 Interaction으로 바궈주기
...
EBTNodeResult::Type UBTTask_Interaction::AbortTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
void UBTTask_Interaction::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
...
void UBTTask_Interaction::OnTaskFinished(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, EBTNodeResult::Type TaskResult)
{
